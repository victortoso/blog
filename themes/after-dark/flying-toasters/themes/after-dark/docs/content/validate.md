...
{{< hackcss-form name="validate" action="/validate/" >}}
  {{< hackcss-formgroup name="integrity" >}}
    ...
    >}}
    {{< hackcss-helpblock >}}
      Submit with 7.2.0 <a href="/feature/release-hashes">Release Hash</a> to validate.
...
<script>
  (function (window, document, undefined) {
    "use strict";
    const digest = 'heINbY6xk/LTEn3URehRr0ncSmRpHMp5unoiYR0rbZWv9JmWdjDRUrhknnOT+hPMbILklJHPN0GALg2wUFdfMw==';
    const confirm = form => {
